...
Donate link:
Tags: BuddyPress, shortcode, shortcodes, profile, social, groups, members, BP Follow
Tested up to: 6.6
Stable tag: 2.6.0
...
* Supports four list formats; option="list" - linked text list, option="avatar-grid" - grid of group, followers, following or friends avatars, option="avatar-grid-name" - Grid of group avatars with a name link, option="avatar-list" - List of links including Avatar and name.
...
**[bpps_profile_lists list_type="following"  option="avatar-list" s_title="default" display_count="true"]**

* Will display a list of who the current user is following, their avatar, their last update, and the total following count.
